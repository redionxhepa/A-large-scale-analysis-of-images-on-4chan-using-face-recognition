...
files=["/home/redion/Desktop/ResearchMPI/PhotosWiki/Threshold5_twoTokenNames/James Lovelock.png",
"/home/redion/Desktop/ResearchMPI/PhotosWiki/Threshold5_twoTokenNames/Jeff Foxworthy.png"]
...
try:
  #extract the features  using multiprocessing
   with parallel_backend('multiprocessing'):
        Parallel(n_jobs=workers)(delayed(extractEncoding)(files[0],jsonFile) for i in tqdm(range(0,lengthFiles)))
except Exception as e:
